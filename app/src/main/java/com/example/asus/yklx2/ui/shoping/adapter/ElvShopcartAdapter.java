package com.example.asus.yklx2.ui.shoping.adapter;
...
public class ElvShopcartAdapter extends BaseExpandableListAdapter {
    ...
    private int flag = 0;
    public ElvShopcartAdapter(Context context, List<SellerBean> groupList, List<List<CartsBean.DataBean.ListBean>> childList, ShopCartPresenter mPresenter) {
...
//        sellerBean.setBg("编辑");
        ...
        final  List<CartsBean.DataBean.ListBean> listBeans = childList.get(groupPosition);
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        final CartsBean.DataBean.ListBean listBean = childList.get(groupPosition).get(childPosition);
    ...
    private void updateProductInSeller() {
        ...
        //获取pid
        CartsBean.DataBean.ListBean listBean = childList.get(groupPosition).get(productIndex);
        int num = listBean.getNum();
        int pid = listBean.getPid();
    ...
    public String[] computeMoneyAndNum() {
        ...
        for (int i = 0; i <groupList.size() ; i++) {
            for (int j = 0; j < childList.get(i).size(); j++) {
                //判断商品是否选中
                CartsBean.DataBean.ListBean listBean = childList.get(i).get(j);
